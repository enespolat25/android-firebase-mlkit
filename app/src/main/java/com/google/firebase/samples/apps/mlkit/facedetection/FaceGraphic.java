...
public class FaceGraphic extends Graphic {
  ...
  public void draw(Canvas canvas) {
    ...
    //bitir
    canvas.drawText(
        "mutluluk: " + String.format("%.2f", face.getSmilingProbability()),
        x + ID_X_OFFSET * 3,
        y - ID_Y_OFFSET,
        idPaint);
    ...
    if (facing == CameraSource.CAMERA_FACING_FRONT) {
      canvas.drawText(
          "sağ göz: " + String.format("%.2f", face.getRightEyeOpenProbability()),
          x - ID_X_OFFSET,
          y,
          idPaint);

      canvas.drawText(
          "sol göz: " + String.format("%.2f", face.getLeftEyeOpenProbability()),
          x + ID_X_OFFSET * 6,
          y,
          idPaint);
